    ...
    <div className="flex flex-col min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1">
              <Phone size={14} /> (11) 98194-8844
            </span>
            <span className="flex items-center gap-1">
              <Mail size={14} /> semeandofuturo@gmail.com
            </span>
          </div>
          <div className="flex items-center gap-3">
            <a
              href="https://www.facebook.com/escolasemeandoofuturocotia"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://instagram.com/semeandofuturocotia"
              target="_blank"
              rel="noreferrer"
              className="hover:text-brand-yellow transition"
              arial-label="Facebook"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          >
            <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center text-white font-bold text-xl group-hover:rotate-12 transition-transform lg:w-20 md:w-64 w-32">
              <img
                src="/images/Logo_Semeando_FuturoSemFundo.png"
                alt="logo da escola semeando o futuro"
                srcset=""
              />
            </div>
            <div className="leading-tight">
              <h1 className="text-lg md:text-xl font-bold text-[#235f5b]">
                Semeando
              </h1>
              <span className="text-[#235f5b] font-semibold text-sm md:text-base">
                Futuro
              </span>
            </div>
          </Link>
            ...
            {navLinks.map((link) =>
              link.path.startsWith("/#") ? (
                ...
                >
                  {link.label}
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-brand-green transition-all ${location.pathname === link.path ? "w-full" : "w-0 group-hover:w-full"}`}
                  ></span>
                </Link>
              ),
            )}
      ...
      >
        <img
          ...
          alt="WhatsApp"
          className="w-10 md:w-10 lg:w-10 h-10"
        />
      </a>
      ...
      <footer className="bg-[#235f5b] text-gray-300 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                <div className="w-10 h-10 bg-brand-green rounded-full flex items-center justify-center text-white font-bold lg:w-20 md:w-64 w-32">
                  <img
                    src="/images/Logo_Semeando_FuturoSemFundo.png"
                    alt="logo da escola semeando o futuro"
                    srcset=""
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-white font-bold mb-6 border-b border-gray-700 pb-2 inline-block">
                Navegação
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  />
                  <span>
                    Rua Miraguai, 173 - Granja Carolina
                    <br />
                    São Paulo - SP
                  </span>
                </li>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white">
            ...
            <p>
              Desenvolvido com <span className="text-red-500">❤</span> por Pixel
              e Performance
            </p>
          </div>
        </div>
