...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2 group" onClick={closeMenu}>
            <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center text-white font-bold text-xl group-hover:rotate-12 transition-transform lg:w-20 md:w-64 w-32">
               <img src="/images/Logo_Semeando_FuturoSemFundo.png" alt="logo da escola semeando o futuro" srcset=""/>
            </div>
      ...
      >
        <img src="/images/whatsapp.png" alt="WhatsApp" className="w-10 md:w-10 lg:w-10 h-10" />
      </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                <div className="w-10 h-10 bg-brand-green rounded-full flex items-center justify-center text-white font-bold lg:w-20 md:w-64 w-32"><img src="/images/Logo_Semeando_FuturoSemFundo.png" alt="logo da escola semeando o futuro" srcset=""/></div>
